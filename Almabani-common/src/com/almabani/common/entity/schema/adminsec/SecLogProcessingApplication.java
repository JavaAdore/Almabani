...
@SequenceGenerator(name = "SecLogProcessingApplication_Id_Seq_Gen", sequenceName = "SEC_LOG_PROCESSING_APPLICATION_ID_SEQ_GEN", allocationSize = 50, initialValue = 50)
