...
import com.almabani.common.enumconverter.ActiveConverter;
...
@SequenceGenerator(name = "ComDepartments_Id_Seq_Gen", sequenceName = "COM_DEPARTMENTS_ID_SEQ_GEN", allocationSize = 50, initialValue = 50)
