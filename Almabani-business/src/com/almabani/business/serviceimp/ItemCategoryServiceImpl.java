...
public class ItemCategoryServiceImpl implements ItemCategoryService {
	...
	@Override
	public List<OamItemCategory> loadItemCategories(Integer first, Integer pageSize, String sortField, boolean assending, Map<String, Object> filters){
		return itemCategoryDAO.loadItemCategories(first,pageSize,sortField,assending,filters);
	}

	@Transactional
	@Override 
	public OamItemCategory addItemCategory(OamItemCategory company) throws AlmabaniException {
	...
	@Transactional
	@Override
	public OamItemCategory updateItemCategory(OamItemCategory company) throws AlmabaniException {
