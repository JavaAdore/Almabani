...
@ManagedBean
@ApplicationScoped
public class ModuleConverter extends AbstractBeanHelper implements Converter {
	...
	public Object getAsObject(FacesContext facesContext, UIComponent component,
		...
		return almabaniFacade.getModule(Long.parseLong(value));
	}
