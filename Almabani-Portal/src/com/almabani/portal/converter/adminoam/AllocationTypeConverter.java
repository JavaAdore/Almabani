...
@ManagedBean
@ApplicationScoped
public class AllocationTypeConverter extends AbstractBeanHelper implements Converter {
	...
	public Object getAsObject(FacesContext facesContext, UIComponent component,
		...
		return almabaniFacade.getAllocationType(getKey(value));
	}
	...
	public String getAsString(FacesContext facesContext, UIComponent component,
		...
		if (object instanceof AllocationType) {
			AllocationType o = (AllocationType) object;
