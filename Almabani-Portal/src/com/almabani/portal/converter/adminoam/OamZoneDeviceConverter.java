...
@ManagedBean
@ApplicationScoped
public class OamZoneDeviceConverter extends AbstractBeanHelper implements Converter {
	...
	public Object getAsObject(FacesContext facesContext, UIComponent component,
		...
		return almabaniFacade.getOamZoneDevice(getKey(value));
	}
	...
	public String getAsString(FacesContext facesContext, UIComponent component,
		...
		if (object instanceof OamZoneDevice) {
			OamZoneDevice o = (OamZoneDevice) object;
